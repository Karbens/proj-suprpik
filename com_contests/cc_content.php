...
if(isset($contest_id) && $contest_id > 0)
{
	...
	{
		echo '<p>You must login to participate in the contests.</p>';
	}
}else
{
			...
			/*echo '<b>'
			  ...
			  echo $contest_image
				 ...
				 . '<span style="vertical-align:bottom;">
					...
					&nbsp;'
				  . "<a onclick=\"javascript:window.open('".$mosConfig_live_site."index.php?option=com_contests&contest_id=".$contest['contest_id']."&terms_and_conditions=1','".$contest['contest_name']." Contest - Terms &amp; Conditions','width=600,height=500,scrollbars=1,toolbar=0,resizable=1');\" href=\"javascript:void(0);\">"
				  . 'Terms &amp; Conditions'
				 . '</a><br><br><br></p>';
			$cc++;
		}
