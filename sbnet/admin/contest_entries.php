...
<?php
	...
	//get contest entries
	$entries = get_contest_entries($contest_id, $contest_date);
		...
		<div class="box" style="margin: 10px auto 10px auto;">
		 <fieldset>
		   ...
		   }else
		   {
			  ...
			  $correct_entries = contest_graded_result($contest_id, $contest_date);
		   ...
		   foreach($entries as $ek => $ev)
		   {
				...
				if($contest_id == 3)
				{
					$ec_count = entered_values_count($contest_id, $contest_date, $ev['entry_value']);
