...
<!--
    ...
    document.writeln('            <p>CONTESTS ADMIN is more friendly with a <b>frames-capable</b> browser.</p>');
...
<frameset cols="220,*" rows="*"  border="1" frameborder="1" framespacing="0">
    ...
    <noframes>
        <body bgcolor="#FFFFFF">
            <p>CONTESTS ADMIN is more friendly with a <b>frames-capable</b> browser.</p>
        </body>
    </noframes>
</frameset>
</noscript>
