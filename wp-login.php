...
case 'register' :
	...
	login_header(__('Registration Form'), '<p class="message register">' . __('Register For This Site') . 
	'<span style="float:right;"><a href="/wp-content/uploads/2013/09/Rules_and_Regulations.pdf" target="_blank">Rules and Regulations</a></span></p>', $errors);
?>
<style>
